...
export default function SiteNav() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/10 bg-[#09090b]/85 backdrop-blur">
      ...
      {open ? (
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-2 border-t border-white/10 px-4 py-4 md:hidden">
          {site.navItems.map((item) => (
            <a
              key={item.href}
              href={item.href}
